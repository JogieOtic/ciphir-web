<div class="h-24 w-full bg-slate-00 flex flex-row-reverse">
  <div class="w-full z-50 bg-slate-600 grid place-items-end">
...
<!-- ====== Date range picker Section End -->
  ...
  <div class="w-full grid content-center px-4">
    <form method="GET" action="{{ route('reporthistory') }}">
      <input 
          type="text" 
          name="search" 
          value="{{ request('search') }}" 
          placeholder="Name, Infrastructures, Issue...." 
          class="border rounded px-2 py-1 w-1/5"
      />
