<div class="flex flex-row w-fit gap-6">
    <div class="flex flex-col gap-6 w-[540px]">
            ...
            <div class="p-4 md:p-5">
                <form class="space-y-4" action="{{ route('addNewIssue')}}" method="POST">
                  ...
                  @method('POST')
                    ...
                    <div>
                        <label for="severity-level" class="block mb-2 text-sm font-medium text-gray-900 ">Select Severity Level</label>
                        <div class="flex flex-col gap-4" required>
                            <div class="flex gap-4">
                                <div class="flex items-center ps-4 border border-gray-200 rounded w-full">
                                    <input id="severity-level-1" type="radio" value="Low" name="severity-level" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                    <label for="severity-level-1" class="w-full py-4 ms-2 text-sm font-medium text-gray-900">Low</label>
                                </div>
                                <div class="flex items-center ps-4 border border-gray-200 rounded w-full">
                                    <input checked id="severity-level-2" type="radio" value="Medium" name="severity-level" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                    <label for="severity-level-2" class="w-full py-4 ms-2 text-sm font-medium text-gray-900">Medium</label>
                                </div>
                            </div>
                            <div class="flex gap-4">
                                <div class="flex items-center ps-4 border border-gray-200 rounded w-full">
                                    <input id="severity-level-1" type="radio" value="High" name="severity-level" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                    <label for="severity-level-1" class="w-full py-4 ms-2 text-sm font-medium text-gray-900">High</label>
                                </div>
                                <div class="flex items-center ps-4 border border-gray-200 rounded w-full">
                                    <input checked id="severity-level-2" type="radio" value="Very High" name="severity-level" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500">
                                    <label for="severity-level-2" class="w-full py-4 ms-2 text-sm font-medium text-gray-900">Very High</label>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div id="add-administrator-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
  <div class="relative p-4 w-full max-w-md max-h-full">
      ...
      <div class="relative bg-white rounded-lg shadow ">
          ...
          <!-- Modal body -->
          <div class="p-4 md:p-5">
              <form class="space-y-4" action="{{ route('addNewAdmin') }}" method="POST">
                @csrf
                @method('POST')
